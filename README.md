...
- **[Claude Golem](https://github.com/EtanHey/claude-golem)** — CLI toolkit for Claude Code: skills system, MCP integrations, 1Password secrets, git worktrees, and autonomous PRD execution
