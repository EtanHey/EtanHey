...
|---------|-------|--------------|
| **[Cantaloupe AI](https://trycantaloupe.com)** | Next.js, React Native, Supabase | AI voice interviews for frontline hiring (QSR, healthcare) |
...
- **[Cantaloupe AI](https://trycantaloupe.com)** — AI-powered recruitment platform with voice interviews
